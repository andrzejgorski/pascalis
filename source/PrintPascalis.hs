...
instance Print Exp where
  prt i e = case e of
    ...
    EFSub exp -> prPrec i 0 (concatD [prt 4 exp, doc (showString "[:]")])
    ELSub exp1 exp2 -> prPrec i 0 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString ":]")])
    ERSub exp1 exp2 -> prPrec i 0 (concatD [prt 4 exp1, doc (showString "[:"), prt 0 exp2, doc (showString "]")])
    ELRSub exp1 exp2 exp3 -> prPrec i 0 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString ":"), prt 0 exp3, doc (showString "]")])
    EKey exp1 exp2 -> prPrec i 0 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString "]")])

...
instance Print Decl where
  prt i e = case e of
    ...
    DAPVar id type_1 type_2 -> prPrec i 0 (concatD [doc (showString "variabilis"), prt 0 id, doc (showString ":"), doc (showString "matrix"), doc (showString "{"), prt 0 type_1, doc (showString "}"), doc (showString "autem"), prt 0 type_2])
...
instance Print Exp where
  prt i e = case e of
    ...
    EFSub exp -> prPrec i 4 (concatD [prt 4 exp, doc (showString "[:]")])
    ELSub exp1 exp2 -> prPrec i 4 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString ":]")])
    ERSub exp1 exp2 -> prPrec i 4 (concatD [prt 4 exp1, doc (showString "[:"), prt 0 exp2, doc (showString "]")])
    ELRSub exp1 exp2 exp3 -> prPrec i 4 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString ":"), prt 0 exp3, doc (showString "]")])
    EKey exp1 exp2 -> prPrec i 4 (concatD [prt 4 exp1, doc (showString "["), prt 0 exp2, doc (showString "]")])
    ...
    ELt exp1 exp2 -> prPrec i 0 (concatD [prt 2 exp1, doc (showString "<"), prt 3 exp2])
    EGt exp1 exp2 -> prPrec i 0 (concatD [prt 2 exp1, doc (showString ">"), prt 3 exp2])
    ELEt exp1 exp2 -> prPrec i 0 (concatD [prt 2 exp1, doc (showString "=<"), prt 3 exp2])
    EGEt exp1 exp2 -> prPrec i 0 (concatD [prt 2 exp1, doc (showString ">="), prt 3 exp2])
